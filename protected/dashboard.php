...
<body>
    ...
    <header>
    <div class="pill">Conectada como <strong><?php echo htmlspecialchars($user['name'] ?: $user['email']); ?></strong></div>
    <a class="btn" href="<?php echo APP_BASE_URL; ?>public/logout.php">Cerrar sesión</a>
    </header>
            ...
            <div class="col-md-6 mb-4">
                <div class="card h-100">
                    <div class="card-body text-center d-flex flex-column justify-content-center">
                        ...
                        <a href="<?php echo APP_BASE_URL; ?>protected/formulario.php" class="btn btn-primary mt-auto">Registrar Nuevo Usuario</a>
                    </div>
                </div>
            </div>
            <div class="col-md-6 mb-4">
                <div class="card h-100">
                    <div class="card-body text-center d-flex flex-column justify-content-center">
                        ...
                        <a href="<?php echo APP_BASE_URL; ?>protected/listar.php" class="btn btn-secondary mt-auto">Ver Usuarios Registrados</a>
                    </div>
                </div>
            </div>
        </div>
