...
$objetivos = $db->query("SELECT * FROM catalogo_objetivos ORDER BY id")->fetchAll(PDO::FETCH_ASSOC);
$equipos = $db->query("SELECT * FROM catalogo_equipos ORDER BY id")->fetchAll(PDO::FETCH_ASSOC);
$lesiones = $db->query("SELECT * FROM catalogo_lesiones ORDER BY id")->fetchAll(PDO::FETCH_ASSOC);
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="procesar.php" method="POST">
                    ...
                    <div class="d-grid gap-2 mt-5"><button type="submit" class="btn btn-primary">Guardar Registros</button></div>
                </form>
            </div>
        </div>
    </div>
